...
//  class ThemeViewController: UIViewController, UISplitViewControllerDelegate {
    ...
    // but making this unspecified from storyboard makes master layout invisible at ipad, so looking for a solution
    ...
    @IBAction func changeTheme(_ sender: UIButton) {
        if let theme = sender.currentTitle {
            ...
            // looking for a solution, as the only way to make master of SplitViewController be shown on iphone is to make its style unspecified
